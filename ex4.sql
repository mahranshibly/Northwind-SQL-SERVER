...
GROUP BY t.CustomerID, c.CompanyName, t.yyyyFormat
WITH ROLLUP
...
ORDER BY c.CompanyName, OrdersYear;


-- I wish my extra is clear...
-- the t.CustomerID is NULL just in one case, 
-- by grouping all orders as null-customerid, 
-- null-year and valid month (not null).
